...
end_TSNE = time() - start_TNSE

# Create PCA model
start_PCA = time() 
pca = PCA(n_components=2) # PC1 and PC2
X_pca = pca.fit_transform(X_scaled)
end_PCA = time() - start_PCA
...
print(f"PCA Model took {end_PCA:0.05f}secs for fitting the data\n")
print(f"t-SNE Model took {end_TSNE:.05f}secs for fitting the data\n")

# Timing performance of t-SNE and PCA are closely 
# t-SNE did better with high densities of data